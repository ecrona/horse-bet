...
export default function WhatEvs({}: Props) {
  ...
  // return (
  //   <div className="h-full bg-horse-gray" style={{ maxWidth: 480 }}>
  ...
  //         <div className="text-large font-medium text-white">Roma</div>
  //       </div>
  ...
  //         <div className="text-large font-medium text-white">Real Sociedad</div>
  //       </div>
  //     </div>
